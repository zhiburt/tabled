...
use tabled::{
    settings::{
        object::Rows,
        style::{HorizontalLine, LineText, StyleBuilder, VerticalLine},
    },
    Table,
};
...
fn main() {
    ...
    let line = HorizontalLine::inherit(StyleBuilder::modern())
        .left(VerticalLine::inherit_left(StyleBuilder::modern()).get_vertical());
