...
test_table!(
    span_col_negative_0,
    Matrix::new(3, 3)
        .with(Modify::new((1, 2)).with(Span::column(-1)))
        .with(Modify::new((2, 3)).with(Span::column(-2)))
        .with(Modify::new((3, 3)).with(Span::column(-100))),
    "+---+----------+----------+----------+"
    "| N | column 0 | column 1 | column 2 |"
    "+---+----------+----------+----------+"
    "| 0 |         0-1         |   0-2    |"
...
test_table!(
    span_col_zero_0,
    Matrix::new(3, 3)
        .with(Modify::new((1, 2)).with(Span::column(0)))
        .with(Modify::new((2, 3)).with(Span::column(0)))
        .with(Modify::new((3, 3)).with(Span::column(-0))),
    "+---+----------+----------+----------+"
    "| N | column 0 | column 1 | column 2 |"
    "+---+----------+----------+----------+"
    "|                0-1                 |"
...
test_table!(
    span_row_negative_0,
    Matrix::new(3, 3)
        .with(Modify::new((2, 1)).with(Span::row(-1)))
        .with(Modify::new((3, 2)).with(Span::row(-2)))
        .with(Modify::new((3, 3)).with(Span::row(-100))),
    "+---+----------+----------+-----+"
    "| N | column 0 | column 1 | 2-2 |"
    "+---+----------+----------+     +"
    "| 0 |   1-0    |   2-1    |     |"
    "+---+          +          +     +"
    "| 1 |          |          |     |"
...
test_table!(
    span_row_zero_0,
    Matrix::new(3, 3)
        .with(Modify::new((2, 1)).with(Span::row(0)))
        .with(Modify::new((3, 2)).with(Span::row(0)))
        .with(Modify::new((3, 3)).with(Span::row(-0))),
    "+---+-----+-----+-----+"
    "| N | 1-0 | 2-1 | 2-2 |"
    "+---+     +     +     +"
    "| 0 |     |     |     |"
