...
use papergrid::config::{pos, AlignmentHorizontal, Borders, Entity, Indent, Sides};
...
test_table!(
    ...
    grid(3, 3)
        .config(|cfg| {
            cfg.set_column_span(pos(0, 0), 3);
            cfg.set_column_span(pos(1, 0), 2);
            cfg.set_column_span(pos(2, 0), 2);
        })
        .build(),
    "+-+-+---+"
    "|0-0    |"
...
test_table!(
    ...
    grid(3, 3)
        .change_cell(pos(0, 0), "0-0xxxxxxx")
        .config(|cfg| {
            cfg.set_column_span(pos(0, 0), 2);
            cfg.set_column_span(pos(1, 1), 2);
        })
        .build(),
    "+-----+----+---+"
    "|0-0xxxxxxx|0-2|"
...
test_table!(
    ...
    grid(3, 3)
        .change_cell(pos(1, 1), "1-1xxxxxxx")
        .config(|cfg| {
            cfg.set_column_span(pos(0, 0), 2);
            cfg.set_column_span(pos(1, 1), 2);
        })
...
test_table!(
    ...
    grid(3, 3)
        .change_cell(pos(1, 1), "1-1xxxxxxx")
        .change_cell(pos(2, 0), "2-0xxxxxxxxxxxxx")
        .config(|cfg| {
            cfg.set_column_span(pos(0, 0), 2);
            cfg.set_column_span(pos(1, 1), 2);
        })
...
test_table!(
    ...
    grid(3, 3)
        .change_cell(pos(2, 1), "2-1xxxxxxxxxxxxx")
        .config(|cfg| {
            cfg.set_column_span(pos(0, 0), 2);
            cfg.set_column_span(pos(1, 1), 2);
        })
...
test_table!(
    ...
    grid(3, 3)
        .change_cell(pos(0, 2), "0-2xxxxxxxxxxxxx")
        .config(|cfg| {
            cfg.set_column_span(pos(0, 0), 2);
            cfg.set_column_span(pos(1, 1), 2);
        })
...
test_table!(
    ...
    grid(3, 3)
        .change_cell(pos(0, 0), "0-0xxxxxxx")
        .config(|cfg| cfg.set_column_span(pos(0, 0), 2))
        .build(),
    "+-----+----+---+"
    "|0-0xxxxxxx|0-2|"
    "+-----+----+---+"
...
test_table!(
    ...
    grid(2, 2)
        .config(|cfg| { cfg.set_column_span(pos(0, 1), 0); })
        .build(),
    "+---+---+"
    "|0-0|0-1|"
    "+---+---+"
