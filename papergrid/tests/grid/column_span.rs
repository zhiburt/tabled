...
use papergrid::config::{AlignmentHorizontal, Borders, Entity, Indent, Position, Sides};
...
test_table!(
    ...
    grid(3, 3)
        .change_cell(Position::new(1, 1), "1-1xxxxxxx")
        .change_cell(Position::new(2, 0), "2-0xxxxxxxxxxxxx")
        .config(|cfg| {
            cfg.set_column_span(Position::new(0, 0), 2);
            cfg.set_column_span(Position::new(1, 1), 2);
        })
...
test_table!(
    ...
    grid(3, 3)
        .change_cell(Position::new(2, 1), "2-1xxxxxxxxxxxxx")
        .config(|cfg| {
            cfg.set_column_span(Position::new(0, 0), 2);
            cfg.set_column_span(Position::new(1, 1), 2);
        })
...
test_table!(
    ...
    grid(3, 3)
        .change_cell(Position::new(0, 2), "0-2xxxxxxxxxxxxx")
        .config(|cfg| {
            cfg.set_column_span(Position::new(0, 0), 2);
            cfg.set_column_span(Position::new(1, 1), 2);
        })
...
test_table!(
    ...
    grid(3, 3)
        .change_cell(Position::new(0, 0), "0-0xxxxxxx")
        .config(|cfg| cfg.set_column_span(Position::new(0, 0), 2))
        .build(),
    "+-----+----+---+"
    "|0-0xxxxxxx|0-2|"
    "+-----+----+---+"
...
test_table!(
    ...
    grid(2, 2)
        .config(|cfg| { cfg.set_column_span(Position::new(0, 1), 0); })
        .build(),
    "+---+---+"
    "|0-0|0-1|"
    "+---+---+"
