...
test_table!(
    _2x2_multiline,
    grid(2, 2)
        .change_cell(Position::new(0, 0), "0-0\n0-1xxx")
        .config(|cfg|{
            cfg.set_row_span(Position::new(0, 0), 2);
            cfg.set_alignment_vertical(Cell(0, 0), AlignmentVertical::Center);
        })
...
test_table!(
    ...
    grid(4, 3)
        ...
        .config(|cfg|{
            cfg.set_row_span(Position::new(0, 0), 2);
            cfg.set_row_span(Position::new(0, 2), 4);
        })
        .build(),
    "+----------+---+--------------+"
    "|first line|0-1|full last line|"
...
test_table!(
    ...
    grid(3, 3)
        .config(|cfg|{
            cfg.set_row_span(Position::new(0, 0), 3);
            cfg.set_row_span(Position::new(0, 1), 2);
            cfg.set_row_span(Position::new(0, 2), 2);
        })
        .build(),
    "+---+---+---+"
    "+0-0+0-1+0-2+"
...
test_table!(
    _3x3_render_1,
    grid(3, 3)
        .change_cell(Position::new(0, 1), "t\ne\nx\nt")
        .config(|cfg|{
            cfg.set_row_span(Position::new(0, 0), 3);
            cfg.set_row_span(Position::new(0, 1), 2);
            cfg.set_row_span(Position::new(0, 2), 2);
...
test_table!(
    _3x3_coliison_0,
    grid(3, 3)
        .change_cell(Position::new(0, 0), "0-0xxxxxxx")
        .config(|cfg|{
            cfg.set_row_span(Position::new(0, 0), 2);
            cfg.set_row_span(Position::new(1, 1), 2);
        })
        .build(),
    "+----------+---+---+"
    "|0-0xxxxxxx|0-1|0-2|"
...
test_table!(
    _3x3_coliison_1,
    grid(3, 3)
        .change_cell(Position::new(1, 1), "1-1xxxxxxx")
        .config(|cfg|{
            cfg.set_row_span(Position::new(0, 0), 2);
            cfg.set_row_span(Position::new(1, 1), 2);
        })
...
test_table!(
    _3x3_coliison_2,
    grid(3, 3)
        .change_cell(Position::new(1, 1), "1-1\nx\nx\nxxxxx")
        .change_cell(Position::new(0, 2), "2-0x\nxxx\nxx\nxxxxxxx")
        .config(|cfg|{
            cfg.set_row_span(Position::new(0, 0), 2);
            cfg.set_row_span(Position::new(1, 1), 2);
        })
...
test_table!(
    _3x3_coliison_3,
    grid(3, 3)
        .change_cell(Position::new(1, 2), "2-1\nxx\nxx\nxx\nxxxxxx\nx")
        .config(|cfg|{
            cfg.set_row_span(Position::new(0, 0), 2);
            cfg.set_row_span(Position::new(1, 1), 2);
        })
...
test_table!(
    _3x3_coliison_4,
    grid(3, 3)
        .change_cell(Position::new(2, 1), "0-2\nx\nx\nx\nx\nxxxxxxx\nx\nx")
        .config(|cfg|{
            cfg.set_row_span(Position::new(0, 0), 2);
            cfg.set_row_span(Position::new(1, 2), 2);
        })
        .build(),
    "+---+-------+---+"
    "|0-0|0-1    |0-2|"
...
test_table!(
    ...
    grid(3, 3)
        .change_cell(Position::new(0, 0), "0-0\nxx\nx\nx\nx\nx\nx")
        .config(|cfg|{ cfg.set_row_span(Position::new(0, 0), 2); })
        .build(),
    "+---+---+---+"
    "|0-0|0-1|0-2|"
    "|xx |   |   |"
...
test_table!(
    ...
    grid(2, 3)
        .change_cell(Position::new(0, 0), "f\nir\nst\n ro\nw")
        .change_cell(Position::new(0, 2), "a\n \nlonger\n \nsecond\n \nrow")
        .change_cell(Position::new(1, 0), "0")
        .change_cell(Position::new(1, 1), "1")
        .config(|cfg|{
            cfg.set_row_span(Position::new(0, 0), 2);
            cfg.set_row_span(Position::new(0, 2), 2);
        })
...
test_table!(
    ...
    grid(2, 2)
        .change_cell(Position::new(0, 0), "3\n \n \n ")
        .change_cell(Position::new(0, 1), "2")
        .change_cell(Position::new(1, 1), "4")
        .config(|cfg|{
            cfg.set_row_span(Position::new(0, 0), 2);
        })
        .build(),
...
test_table!(
    _2x2_render_0,
    grid(2, 2)
        .change_cell(Position::new(0, 0), "1\n\n\n\n\n\n\n23")
        .config(|cfg|{
            cfg.set_row_span(Position::new(0, 0), 2);
        })
        .build(),
...
test_table!(
    ...
    grid(3, 2)
        .config(|cfg|{
            cfg.set_row_span(Position::new(0, 1), 3);
        })
        .build(),
    "+---+---+"
    "|0-0|0-1|"
...
test_table!(
    ...
    grid(4, 4)
        .change_cell(Position::new(1, 1), "123\n345\n555\n333")
        .config(|cfg|{
            cfg.set_row_span(Position::new(1, 1), 2);
            cfg.set_column_span(Position::new(1, 1), 2);
...
test_table!(
    ...
    grid(4, 4)
        .change_cell(Position::new(0, 0), "123\n345\n555\n333")
        .config(|cfg|{
            cfg.set_row_span(Position::new(0, 0), 2);
            cfg.set_column_span(Position::new(0, 0), 2);
...
test_table!(
    ...
    grid(4, 4)
        .change_cell(Position::new(2, 0), "123\n345\n555\n333")
        .config(|cfg|{
            cfg.set_row_span(Position::new(2, 0), 2);
            cfg.set_column_span(Position::new(2, 0), 2);
...
test_table!(
    ...
    grid(4, 4)
        .change_cell(Position::new(2, 2), "123\n345\n555\n333")
        .config(|cfg|{
            cfg.set_row_span(Position::new(2, 2), 2);
            cfg.set_column_span(Position::new(2, 2), 2);
...
test_table!(
    ...
    grid(4, 4)
        .change_cell(Position::new(0, 2), "123\n345\n555\n333")
        .config(|cfg|{
            cfg.set_row_span(Position::new(0, 2), 2);
            cfg.set_column_span(Position::new(0, 2), 2);
...
test_table!(
    ...
    grid(4, 4)
        .change_cell(Position::new(0, 1), "123\n345\n555\n333")
        .config(|cfg|{
            cfg.set_row_span(Position::new(0, 1), 2);
            cfg.set_column_span(Position::new(0, 1), 2);
...
test_table!(
    ...
    grid(4, 4)
        .change_cell(Position::new(1, 1), "123\n345\n555\n333")
        .config(|cfg|{
            cfg.set_row_span(Position::new(1, 1), 3);
...
test_table!(
    ...
    grid(4, 4)
        ...
        .config(|cfg|{
            cfg.set_row_span(Position::new(0, 0), 3);
            cfg.set_column_span(Position::new(0, 0), 3);
            cfg.set_alignment_horizontal(Cell(0, 0), AlignmentHorizontal::Center);
            cfg.set_alignment_vertical(Cell(0, 0), AlignmentVertical::Center);
        })
        .build(),
...
test_table!(
    ...
    grid(4, 4)
        ...
        .config(|cfg|{
            cfg.set_row_span(Position::new(0, 1), 3);
            cfg.set_column_span(Position::new(0, 1), 3);
            cfg.set_alignment_horizontal(Cell(0, 1), AlignmentHorizontal::Center);
            cfg.set_alignment_vertical(Cell(0, 1), AlignmentVertical::Center);
        })
        .build(),
...
test_table!(
    ...
    grid(4, 4)
        .change_cell(Position::new(1, 0), "123\n345\n555\n333")
        .config(|cfg|{
            cfg.set_row_span(Position::new(1, 0), 3);
            cfg.set_column_span(Position::new(1, 0), 3);
...
test_table!(
    ...
    grid(4, 4)
        .change_cell(Position::new(0, 0), "hello\nworld\n!\n!\n!\n!")
        .config(|cfg|{
            cfg.set_column_span(Position::new(1, 1), 2);
            cfg.set_column_span(Position::new(3, 0), 3);
            cfg.set_row_span(Position::new(0, 0), 2);
            cfg.set_row_span(Position::new(0, 3), 3);
        })
        .build(),
    "+-----+---+---+---+"
    "|hello|0-1|0-2|0-3|"
...
test_table!(
    ...
    grid(4, 4)
        .change_cell(Position::new(0, 2), "q\nw\ne\nr\nt")
        .change_cell(Position::new(0, 3), "q1\nw1\ne1\nr1\nt1")
        .config(|cfg|{
            cfg.set_column_span(Position::new(0, 0), 2);
            cfg.set_row_span(Position::new(0, 2), 2);
            cfg.set_row_span(Position::new(0, 3), 3);
...
test_table!(
    ...
    grid(3, 5)
        .change_cell(Position::new(0, 3), "q\nw\ne\nr\nt")
        .change_cell(Position::new(0, 4), "q1\nw1\ne1\nr1\nt1")
        .config(|cfg|{
            cfg.set_column_span(Position::new(0, 0), 2);
            cfg.set_row_span(Position::new(0, 3), 2);
            cfg.set_row_span(Position::new(0, 4), 3);
        })
        .build(),
    "+---+---+---+---+--+"
    "|0-0    |0-2|q  |q1|"
...
test_table!(
    ...
    grid(3, 5)
        .config(|cfg|{
            cfg.set_column_span(Position::new(0, 0), 2);
            cfg.set_column_span(Position::new(1, 0), 2);
            cfg.set_row_span(Position::new(1, 0), 2);
        })
        .build(),
    "+-+-+---+---+---+"
    "|0-0|0-2|0-3|0-4|"
...
test_table!(
    ...
    grid(5, 2)
        .change_cell(Position::new(1, 1), "1\n2\n3\n4")
        .config(|cfg|{
            cfg.set_row_span(Position::new(1, 1), 4);
        })
        .build(),
    "+---+---+"
    "|0-0|0-1|"
...
test_table!(
    ...
    grid(3, 4)
        .config(|cfg|{
            cfg.set_column_span(Position::new(0, 0), 3);
            cfg.set_column_span(Position::new(1, 0), 3);
            cfg.set_column_span(Position::new(2, 0), 3);
        })
        .build(),
    "+-+++---+"
    "|0-0|0-3|"
...
test_table!(
    _3x4_column_span_2,
    grid(3, 4)
        .change_cell(Position::new(0, 0), "")
        .change_cell(Position::new(1, 0), "")
        .change_cell(Position::new(2, 0), "")
        .config(|cfg|{
            cfg.set_column_span(Position::new(0, 0), 3);
            cfg.set_column_span(Position::new(1, 0), 3);
            cfg.set_column_span(Position::new(2, 0), 3);
