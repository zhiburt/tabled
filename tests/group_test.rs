...
test_table!(
    group_str_duplication_test,
        group!("duplicate me"; 5),
    "+--------------+--------------+--------------+--------------+--------------+"
...
test_table!(
    group_display_mixed_test,
        group!("str", "string".to_string(), 55, false),
    "+-----+--------+----+-------+"
    "| str | string | 55 | false |"
    "+-----+--------+----+-------+"
);
...
test_table!(
    group_display_mixed_rows_test,
        group!("str", "string".to_string(), 55, false; 2),
    "+-----+--------+"
    "| str | string |"
    "+-----+--------+"
    "| 55  | false  |"
