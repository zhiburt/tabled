...
The next example illustrates a builder method.
...
There are numerous included styles.
...
Below is a rendered list of the incl styles.
...
Also you can build your own one from scratch,
and doing so is not always possible at compile time,
...
We still do it.
We often do breaking changea on minor version bump.
